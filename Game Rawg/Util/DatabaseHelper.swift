    ...
    func readAllFavorite()->[Game]{
        ...
        do{
            ...
            result.forEach{ game in
                games.append(Game(id: game.value(forKey: "id") as! Int, judul: game.value(forKey: "judul") as! String, gambar: game.value(forKey: "gambar") as! String, tanggalRilis: game.value(forKey: "tanggalRilis") as! String, peringkat: game.value(forKey: "peringkat") as! Double))
            }
        }catch let err{
            print(err)
        }
